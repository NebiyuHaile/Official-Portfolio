        ...
        {projects.map((project, i) => (
          <Reveal key={project.id} delay={i * 0.1}>
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="group block h-full scroll-mt-16 rounded-lg border border-border bg-bg-elevated p-6 transition-all duration-300 hover:-translate-y-1 hover:border-accent/50 hover:shadow-lg hover:shadow-accent/5"
            >
              ...
              <h3 className="mt-3 text-lg font-semibold text-fg group-hover:text-accent">
                {project.name}
              </h3>
